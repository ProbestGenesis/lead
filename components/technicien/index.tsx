...
export const ContactForm = () => {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1}} animate={{ transition: {duration: 0.8} }} className="flex w-full h-full max-sm:h-screen flex-col space-y-8 items-center justify-center px-8 text-left bg-white">
